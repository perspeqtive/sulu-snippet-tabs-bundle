 ...
 */
class getSuluPage_Export_ManagerService extends PERSPEQTIVE_SuluSnippetTabsBundle_Tests_Application_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->privates['sulu_page.export.manager'] = $instance = new \Sulu\Component\Export\Manager\ExportManager(($container->services['sulu.content.type_manager'] ?? self::getSulu_Content_TypeManagerService($container)));
        ...
        $instance->add('single_icon_selection', '1.2.xliff', ['translate' => true]);
