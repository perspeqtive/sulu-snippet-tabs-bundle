 ...
 */
class getMassiveSearch_ConverterService extends PERSPEQTIVE_SuluSnippetTabsBundle_Tests_Application_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addConverter('date', ($container->privates['massive_search.converter.date_converter'] ??= new \Massive\Bundle\SearchBundle\Search\Converter\Types\DateConverter()));
        $instance->addConverter('json', ($container->privates['massive_search.converter.json_converter'] ??= new \Massive\Bundle\SearchBundle\Search\Converter\Types\JsonConverter()));
